...
// 
//
// Related Topics 设计 数组 哈希表 模拟 👍 68 👎 0
...
class Bank {
    ...
    public boolean transfer(int account1, int account2, long money) {
        ...
        long num1 = balance[account1 - 1];
        long num2 = balance[account2 - 1];
        if (num1 >= money) {
            if (account1 == account2) {
                return true;
            }
            balance[account1 - 1] = num1 - money;
            balance[account2 - 1] = num2 + money;
            return true;
        }
        return false;
    }
    ...
    public boolean withdraw(int account, long money) {
        ...
        long num = balance[account - 1];
        if (num >= money) {
            balance[account - 1] = num - money;
            return true;
        }
        return false;
    }
